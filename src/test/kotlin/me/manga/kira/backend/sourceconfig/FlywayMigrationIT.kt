 ...
 * V13.2 initial-catalog classification, then V14..V22 complaint migrations (24 total),
...
class FlywayMigrationIT : AbstractIntegrationTest() {
    ...
    @Test
    fun `flyway history is exactly V1 through V22 including V13_1 and V13_2 in version order`() {
        val versions =
        ...
        assertEquals((1..13).map(Int::toString) + listOf("13.1", "13.2") + (14..22).map(Int::toString), versions)
    }
