...
object SourceConfigFixtures {
    ...
    fun validGenericSource(api: String = "GenSrc"): SourceConfig =
        SourceConfig(
            api = api,
            language = "en",
    ...
    fun validLegacySource(api: String = "LegSrc"): SourceConfig =
        SourceConfig(
            api = api,
            language = "en",
    ...
    fun validFilter(id: String = "genres"): FilterDefinition =
        FilterDefinition(
            id = id,
            label = "Genres",
            type = "multiselect",
    ...
    fun document(vararg sources: SourceConfig): SourceConfigDocument =
        SourceConfigDocument(schemaVersion = 1, revision = 1, sources = sources.toList())

    /** Load a classpath fixture (`/fixtures/<name>`) as text. */
    fun loadFixture(name: String): String =
        requireNotNull(SourceConfigFixtures::class.java.getResourceAsStream("/fixtures/$name")) {
