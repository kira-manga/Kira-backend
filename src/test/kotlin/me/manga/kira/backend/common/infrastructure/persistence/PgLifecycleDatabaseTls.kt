...
internal class PgLifecycleDatabaseTls private constructor(val root: Path, private val controllerOwned: Boolean) : AutoCloseable {
    ...
    companion object {
        ...
        val CLASS_NAMES = setOf(
            ...
            "me.manga.kira.backend.complaint.infrastructure.reconciliation.TestActiveServiceIT",
            ...
            "me.manga.kira.backend.complaint.infrastructure.reconciliation.TestRegisteredOwnerDeleteHttpIT",
            ...
            "me.manga.kira.backend.complaint.infrastructure.reconciliation.TestRegisteredCompleteHttpIT",
