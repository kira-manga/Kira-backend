...
class AuthFlowIT
@Autowired
constructor(private val mockMvc: MockMvc, private val objectMapper: ObjectMapper, private val jwtDecoder: JwtDecoder) :
    AbstractIntegrationTest() {

    private val email = "flow@example.com"
    private val password = "correct horse battery staple"

    private fun body(email: String, password: String): String = objectMapper.writeValueAsString(mapOf("email" to email, "password" to password))
