...
@Autowired
constructor(private val mockMvc: MockMvc, private val objectMapper: ObjectMapper) : AbstractIntegrationTest() {
    ...
    private fun login(email: String, pw: String): ResultActionsDsl = mockMvc.post("/api/v1/auth/login") {
        contentType = MediaType.APPLICATION_JSON
