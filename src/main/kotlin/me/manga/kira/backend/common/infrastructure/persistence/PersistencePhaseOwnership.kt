...
internal class PersistencePhaseOwnership private constructor(
    ...
    internal fun enterTestNamespaceActiveRegistration(original: ComplaintTestNamespaceActiveRegistrationAttemptV1): PersistencePhaseContext =
        enter(PersistencePhasePath.COMPLAINT_TEST_NAMESPACE_ACTIVE_REGISTRATION, testActiveRegistration = original)
    ...
    internal fun enterTestActiveOrdinarySealRecovery(original: TestActiveOrdinarySealRecoveryV1): PersistencePhaseContext =
        enter(original.path, testActiveSealRecovery = original)
    ...
    private fun enter(
        ...
        if ((path === PersistencePhasePath.COMPLAINT_TEST_NAMESPACE_ACTIVE_REGISTRATION) != (testActiveRegistration != null)) {
            throw PersistencePhaseException(PersistencePhaseFailureCode.RESOURCE_REFUSED)
        }
        ...
        if (path.testActiveOrdinarySealRecovery != (testActiveSealRecovery != null)) {
            throw PersistencePhaseException(PersistencePhaseFailureCode.RESOURCE_REFUSED)
        }
    ...
    private sealed interface Selection {
        ...
        class Ordinary(
            ...
            override fun acquire(path: PersistencePhasePath): LocalPersistencePermit? = when (path) {
                ...
                PersistencePhasePath.COMPLAINT_TEST_ACTIVE_RECURRENT,
...
internal enum class PersistencePhasePath {
    ...
    COMPLAINT_TEST_ACTIVE_RECURRENT,
    ...
    internal val testActiveRecurrent: Boolean
        get() = this === COMPLAINT_TEST_ACTIVE_RECURRENT
    internal val testActiveOrdinarySealRecovery: Boolean
        get() = this === COMPLAINT_TEST_ACTIVE_ORDINARY_SEAL_RECOVERY

    internal val testActiveOrdinarySeal: Boolean
        get() = this === COMPLAINT_TEST_ACTIVE_ORDINARY_SEAL || this === COMPLAINT_TEST_ACTIVE_CUTOFF_EVIDENCE
    ...
    internal val testActiveFirstCut: Boolean
