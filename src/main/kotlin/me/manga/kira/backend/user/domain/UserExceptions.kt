...
class DuplicateEmailException :
    ConflictException("Email is already registered.", code = "EMAIL_ALREADY_EXISTS")

/** 404 — no user with the given id. */
class UserNotFoundException :
    NotFoundException("User not found.", code = "USER_NOT_FOUND")
...
class LastAdminException :
    ConflictException("Cannot disable the last enabled admin.", code = "LAST_ADMIN")
