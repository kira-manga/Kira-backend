...
/** Only the original ingress owner's private registered handoff authorizes ADMIN_EDIT. */
internal interface ComplaintAdmittedAdminContent

internal sealed interface ComplaintAdminContentAdmissionPolicy {
    data object Disabled : ComplaintAdminContentAdmissionPolicy
    ...
    class Bounded(
        ...
        val pruneBatch: Int,
        val perHour: Int = 60,
    ) : ComplaintAdminContentAdmissionPolicy {
        init {
        ...
        override fun toString(): String = "ComplaintAdminContentAdmissionPolicy.Bounded(redacted)"
    }
}

/** Same hourly store and same finite mutation-member owner as co-composed owner writes; no Admin-read minute bucket. */
internal class ComplaintAdminContentAdmissionStore(
    private val policy: ComplaintAdminContentAdmissionPolicy.Bounded,
    ...
    override fun toString(): String = "ComplaintAdminContentAdmissionStore(bounded,redacted)"
}
