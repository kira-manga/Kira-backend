...
/**
 * Dormant actual SDK adapter for one retained TEST J's fixed OWNER_DELETE profile. No key
 ...
 */
internal class AwsTestOwnerDeleteDataKeyAdapterV1 private constructor(
    val journal: TestOwnerDeleteJournalConfigurationV1,
    private val profile: TestOwnerDeleteKmsRequestProfileV1,
    ...
    override fun toString(): String = "AwsTestOwnerDeleteDataKeyAdapterV1(J-bound,redacted,no-activation-authority)"
    ...
    internal class Construction : AutoCloseable {
        ...
        private var owner: AwsTestOwnerDeleteDataKeyAdapterV1? = null
        ...
        internal fun open(
        ...
        ): AwsTestOwnerDeleteDataKeyAdapterV1 {
            requireConnectionFree()
            return journalKmsSdkCall {
                ...
                val result = runCatching {
                    ...
                    val profile = TestOwnerDeleteKmsRequestProfileV1(journal)
                    ...
                    attempt?.remainingMillis(1)
                    AwsTestOwnerDeleteDataKeyAdapterV1(journal, profile, sdk, transport, nanoTime).also { owner = it }
                }
    ...
    companion object {
        fun open(journal: TestOwnerDeleteJournalConfigurationV1, credentials: AwsSessionCredentials): AwsTestOwnerDeleteDataKeyAdapterV1 =
        ...
        ): AwsTestOwnerDeleteDataKeyAdapterV1 = Construction().open(journal, credentials, { httpFactory() }, nanoTime, null)
        ...
        private const val PROFILE_NAME = "complaint-test-owner-delete-data-key-v1"
    }
}
