...
internal class AwsTestOrdinarySealStsV1 private constructor(
    ...
    private val s3Construction = TestOrdinarySealS3ClientV1.Construction()
    ...
    private var original: TestOrdinarySealCustodyV1? = null
    private var encoded = false
    private var published = false

    internal fun acquireOwned(custody: TestOrdinarySealCustodyV1) = epochSealStsCall {
        ...
        val policy = EpochSealStsPolicy.forKey(routing.journalConfiguration, row.binding.objectKey, row.binding.epochEndInclusive)
    ...
    internal fun sealOwned(custody: TestOrdinarySealCustodyV1): TestTerminalEnvelopeV1 = epochSealStsCall {
        requireSession(custody)
    ...
    private fun keys(custody: TestOrdinarySealCustodyV1): AwsTestTerminalDataKeyAdapterV1 {
        requireSession(custody)
    ...
    private fun requireSession(custody: TestOrdinarySealCustodyV1) {
        requireConnectionFree()
        custody.requireSts(this)
    ...
    override fun toString(): String = "AwsTestOrdinarySealStsV1(private-original-custody,redacted,no-external-policy-acceptance)"
