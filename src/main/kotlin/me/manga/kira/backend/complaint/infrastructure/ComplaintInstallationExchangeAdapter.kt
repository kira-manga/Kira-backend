...
/** Concrete cold TEST composition only. Desired settings are comparison input, never activation/restore authority. */
...
internal class ComplaintInstallationExchangeAdapter(
    ...
    override fun toString(): String = "ComplaintInstallationExchangeAdapter(TEST-only,no-mode-authority)"
