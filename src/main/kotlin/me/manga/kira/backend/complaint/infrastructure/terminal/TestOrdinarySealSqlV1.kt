...
internal object TestOrdinarySealSqlV1 {
    ...
    val completeRelation = """
        ...
        SELECT (NOT EXISTS (SELECT 1 FROM complaint_journal_publications p CROSS JOIN expected e
            ...
            AND NOT EXISTS (SELECT 1 FROM complaint_installation_ids r CROSS JOIN expected e WHERE r.data_scope_id = e.scope AND r.state IN ('DELETION_PENDING', 'RECOVERY_RESERVED'))
