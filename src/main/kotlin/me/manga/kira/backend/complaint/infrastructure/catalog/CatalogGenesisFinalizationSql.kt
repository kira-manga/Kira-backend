...
private val GENESIS_CONTROL_EXPECTED = """
    WITH expected AS (SELECT ?::bytea AS envelope_hash, ?::bytea AS trust_hash, ?::uuid AS writer, ?::uuid AS token,
        ?::uuid AS database_identity, ?::uuid AS restore_identity, ?::uuid AS event_writer, ?::bytea AS configuration_hash)
""".trimIndent()
...
private val GENESIS_INITIAL_CONTROL = """
    ...
    AND c.implementation_schema = 1 AND c.desired_generation > 0
    ...
    AND (c.desired_configuration_hash IS NULL OR c.desired_configuration_hash = e.configuration_hash)
""".trimIndent()
