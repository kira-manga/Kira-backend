...
internal object TestTerminalDurableStorageProfileV1 {
    ...
    // Supporting publication_ref/data_scope_id FK index: 32 + d(43) + UUID16.
    const val PUBLICATION_INDEX_BYTES = 96L
    const val MAX_INDEX_BYTES = OPERATION_INDEX_BYTES + SCOPE_KIND_ORDINAL_INDEX_BYTES +
        OBJECT_KEY_INDEX_BYTES + OBJECT_ID_INDEX_BYTES + PUBLICATION_INDEX_BYTES
