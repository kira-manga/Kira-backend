 ...
 */
internal class CatalogSignerRotationDeliveryAssemblyV1(
    ...
    private val inputs: CatalogSignerRotationInputsV1 get() = original.inputs

    internal fun acquire(request: CatalogSignerRotationFreezeRequestV1): CatalogSignerRotationInputsV1 {
    ...
    internal fun requireProof(proof: CatalogDualLocationVerifier.Overlap2Readback) {
        requireConnectionFree()
        original.requireRunning()
    ...
    override fun toString(): String = "CatalogSignerRotationDeliveryAssemblyV1(original-SDK-cleanup,one-primary-put,no-Sign,redacted)"
}
