-- Forward-only OWNER_REPLY completion. Extend only the reused-resource rejection cell from V15.
-- All accepted migrations, other result branches, phase/expiry/external checks and closed seeds remain unchanged.
