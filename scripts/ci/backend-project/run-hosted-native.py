#!/usr/bin/python3.12
"""INERT full native3 successor: failure-only supplier diagnostics, unchanged qualification gates."""
import fcntl
import hashlib
...
PROFILE = 'HOSTED_NATIVE_CLASS3_SUPPLIER_DIAGNOSTIC_UNQUALIFIED'
LOCK_FD = None
